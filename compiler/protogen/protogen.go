...
import (
	...
	"github.com/Raccoon-AI/protobuf-go/internal/editiondefaults"
...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/Raccoon-AI/protobuf-go/types/known/anypb";
	//
...
// For example: "github.com/Raccoon-AI/protobuf-go/compiler/protogen"
