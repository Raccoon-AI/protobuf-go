...
// MessageV2 is the [github.com/Raccoon-AI/protobuf-go/proto.Message] type used by the
// current [github.com/Raccoon-AI/protobuf-go] module, adding support for reflection.
