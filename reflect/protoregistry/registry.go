...
//
//	go build -ldflags "-X github.com/Raccoon-AI/protobuf-go/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/Raccoon-AI/protobuf-go/types/known/" + pkgName
	panic(fmt.Sprintf(""+
